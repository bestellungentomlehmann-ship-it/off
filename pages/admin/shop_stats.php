...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="<?php echo asset('pages/admin/shop_manage.php'); ?>"
               class="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all font-medium text-sm no-underline">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        ...
        <div class="card rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-4 pb-2 sm:px-6 sm:pt-6 flex items-start justify-between gap-3">
                <div class="min-w-0">
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2">Bestellungen</p>
                    <p class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-50 leading-none break-words"><?php echo number_format($totalOrders); ?></p>
        ...
        <div class="card rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-4 pb-2 sm:px-6 sm:pt-6 flex items-start justify-between gap-3">
                <div class="min-w-0">
                    ...
                    <p class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-gray-50 leading-none break-words"><?php echo number_format($totalRevenue, 2, ',', '.'); ?> <span class="text-xl sm:text-2xl md:text-3xl">€</span></p>
        ...
        <div class="card rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-4 pb-2 sm:px-6 sm:pt-6 flex items-start justify-between gap-3">
                <div class="min-w-0">
                    ...
                    <p class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-gray-50 leading-none break-words"><?php echo number_format($avgRevenue, 2, ',', '.'); ?> <span class="text-xl sm:text-2xl md:text-3xl">€</span></p>
    ...
    <div class="card rounded-xl shadow-lg p-6 sm:p-10 text-center text-gray-500 dark:text-gray-400">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
        ...
        <div class="card rounded-xl shadow-lg p-6">
            ...
            <div class="relative h-[240px] sm:h-[300px]">
