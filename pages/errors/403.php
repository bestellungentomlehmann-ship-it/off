...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
    <div class="mb-6">
        <span class="text-8xl font-extrabold text-ibc-blue dark:text-ibc-blue-light select-none">403</span>
    </div>
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-3">
        <i class="fas fa-lock mr-2 text-ibc-green" aria-hidden="true"></i>
        Kein Zugriff
    </h1>
    <p class="text-gray-600 dark:text-gray-300 text-lg max-w-md mb-8">
        Du hast leider keine Berechtigung, diese Seite aufzurufen. Falls du glaubst, dass dies ein Fehler ist, wende dich bitte an einen Administrator.
    </p>
...
<head>
    ...
    <style>
        body { font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #f1f5f9; color: #1e293b; display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; }
        .error-box { background: #fff; border-radius: 1.5rem; box-shadow: 0 8px 32px rgba(0,0,0,0.10); padding: 3rem 2.5rem; max-width: 480px; width: 100%; text-align: center; }
...
<body>
    <div class="error-box">
        ...
        <h1><i class="fas fa-lock me-2 text-success"></i>Kein Zugriff</h1>
        <p>Du hast leider keine Berechtigung, diese Seite aufzurufen. Falls du glaubst, dass dies ein Fehler ist, wende dich bitte an einen Administrator.</p>
